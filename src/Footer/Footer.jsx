...
const Footer = () => {
    return (
        <section id='Contact' className="py-10 px-5 bg-black sm:pt-16 lg:pt-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <h1 className="text-3xl font-bold text-blue-500 ">©Zenui</h1>
                    ...
                    <div className='dark:text-white-toned'>
                        ...
                        <ul className="mt-6 space-y-4 font-Oswald tracking-widest ">
                            ...
                            <li>
                                <a href="#About" title="" className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About </a>
                            </li>

                            <li>
                                <a href="#Contact" title="" className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Contact </a>
                            </li>

                            <li>
                                <a href="#service" title="" className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Service </a>
                            </li>
                        </ul>
                    </div>
                ...
                <p className="text-sm text-center text-gray-600">© Copyright 2021, All Rights Reserved by ©Zenui</p>
            </div>
        </section>
